...
<?php
  ...
  if(!empty($_FILES['uploaded_file']))
  {
    ...
    echo "MIME TYPE * : ".mime_content_type($_FILES['uploaded_file']['tmp_name']) ."</br><br />"; 
    $mimeType = mime_content_type($_FILES['uploaded_file']['tmp_name']);
    //CHECK THE MIME TYPE
    if ($mimeType == "text/plain")echo " CHECK MIME TYPE.";
    // upload file here but check mime type
