...
while(count < iterations):
 rv = int(random.randint(mn,mx))
 sum = sum + rv
 if (count % 10 == 0 and count != 0):
  print()
 
 print (str(rv) + str(" "), end="") #var end was deleted
...
print("minimum value: " + str(mn))
print("minimum value count: " + str(count_mn))
print("median value: " + str(md))
print("median value count: " + str(count_md))
print("maximum value: " + str(mx))
print("maximum value count: " + str(count_mx))
print("meadian value: " + str(sum/iterations))
